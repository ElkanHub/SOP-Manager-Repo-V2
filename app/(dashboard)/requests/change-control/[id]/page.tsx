...
export default async function ChangeControlRequestDetailPage({ params }: Props) {
    ...
    const isRequester = cc.requester_id === user.id
    // Requesters see their own CCs; QA/Admin can view any from the requester side too.
    if (!isRequester && !canManage) redirect("/requests/change-control")
