...
const STATUS_LABELS: Record<ChangeControlPackageStatus, string> = {
    ...
    impact_pending: "Impact Assessment",
...
const STATUS_CLASS: Partial<Record<ChangeControlPackageStatus, string>> = {
    ...
    impact_pending: "border-blue-200 bg-blue-50 text-blue-800",
    classified: "border-blue-200 bg-blue-50 text-blue-800",
    ...
    effectiveness_review: "border-green-200 bg-green-50 text-green-800",
